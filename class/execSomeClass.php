...
$arrayAfterPush    = StackPush::execStackPush('MARU', 4312098, 123, $originalArray);
//var_dump($arrayAfterPush);

$arrayAfterPop     = StackPop::execStackPop(2, $originalArray);
//var_dump($arrayAfterPop);

$arrayAfterEnqueue = QueueEnqueue::execQueueEnqueue(6, 'hoge', $originalArray);
//var_dump($arrayAfterEnqueue);

$arrayAfterDequeue = QueueDequeue::execQueueDequeue(3, $originalArray);
